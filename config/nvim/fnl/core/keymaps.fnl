...
(keymaps! {[:n :x] {"<F13>" {:desc "Alternative localleader"
                     ...
                     :<localleader> {:<ESC> {:desc "Cancel prefix" :callback (fn [])}}}
...
(keymaps! {:n {:<leader>U :<leader>u
               :<leader>u {:h {:desc "Toggle Inlay Hints"
                           ...
                           :s {:desc "Toggle Spell Check"
                               :callback #(set vim.wo.spell (not vim.wo.spell))}
...
;; Open things
(keymaps! {:n {:<leader>o {:q {:desc "Open Quickfix"
                           ...
                           :p {:desc "Open Plugin Files"
                               :callback :<Plug>pick#plugin-files}
                           :P {:desc "Grep Plugin Directory"
                               :callback :<Plug>pick#plugin-grep}
